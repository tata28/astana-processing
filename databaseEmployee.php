                        ...
                        <div class="d-flex justify-content-between">
                            <div class="container">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-sm">
                                        <h4 style="text-align:left;">Data Employee</h4>
                                    </div>
                                    <div class="col-sm">
                                ...
                                <table id="mytable" class="table table-hover table-striped table-light" style="text-align:left">
                                    ...
                                    <tbody>
                                        ...
                                        <td>12345</td>
                                            ...
                                            <td>
                                                <div class='btn-group'>
                                                    <button type='button' class="btn btn-edit" onclick="location.href='editEmployee.php'" style="color: #FDBE33;">
                                                ...
                                                <div class="modal-body">
                                                    <button id="btnModalBiodata" onclick="msuccess('remove')" style="text-align:left">
                                                        <a style="color: rgba(3, 15, 39, 1);">
                                                            <i class='fas fa-edit'></i>&nbspRemove Employee</a></button>
                                                    <hr>
