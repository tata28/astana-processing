                        ...
                        <div class="d-flex justify-content-between">
                            <div class="container">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-sm">
                                        <h4 style="text-align:left;">Tanda Terima Tagihan</h4>
                                    </div>
                                    <div class="col-sm">
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="location.href='addTandaTerimaTagihan.php'">
                                                <span>+ Add</span>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <table id="mytable" class="table table-hover table-striped table-light" style="text-align:left">
                                    <thead>
                                        ...
                                        <th scope="col">Branch</th>
                                            ...
                                            <th scope="col">No Pembayaran Utang</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Gudang</td>
                                            <td>80</td>
                                            <td>AAA- PERMEN LUNAK</td>
                                            <td>Jalan Kalianak</td>
                                            <td>1234567</td>
                                            <td>BCA</td>
                                            <td>12313123</td>
                                            <td>Non PPN</td>
